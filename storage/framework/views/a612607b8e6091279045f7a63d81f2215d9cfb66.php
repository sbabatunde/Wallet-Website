                        ...
                        <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                            ...
                            <tbody id="append">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $translators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $translate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr>
                                        <td>
                                            <textarea type="text" name="key[]" class="form-control"><?php echo e(clean($key)); ?></textarea>
                                        </td>
                                        
                                        <td>
                                            <textarea type="text" name="value[]" class="form-control"><?php echo e(clean($translate)); ?></textarea>
                                        </td>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/safeasse/domains/safeassetsunion.com/public_html/core/resources/views/backend/language/translate.blade.php ENDPATH**/ ?>