    ...
    <section class="auth-section auth-section-two">
        <div class="auth-wrapper">
            <div class="auth-top-part">
                ...
                <p class="mb-0"><span class="me-2"><?php echo e(__('Already registered?')); ?></span> <a class="sp_theme_btn btn-sm" href="<?php echo e(route('user.login')); ?>"><?php echo e(__('Login')); ?></a></p>
            </div>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-12">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="exampleCheck1"><?php echo e(__('I agree to the')); ?> <a href="<?php echo e(route('privacy')); ?>" target="_blank"  class="color-change">Terms and Conditions</a></label>
                                </div>
                            </div>
                            <div class="col-lg-12">
...
<?php echo $__env->make(template().'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/safeasse/domains/safeassetsunion.com/public_html/core/resources/views/theme2/user/auth/register.blade.php ENDPATH**/ ?>