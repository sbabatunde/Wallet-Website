...
<script type="text/javascript" src="temp/js/jquery.fake-notification.min.js"></script>
 ...
 <link rel="stylesheet" href="<?php echo e(asset('asset/temp/font-awesome.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('asset/temp/css/fake-notification-min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('asset/temp/css/animate.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('asset/temp/css/font-awesome.min.css')); ?>">
<script type="text/javascript" src="<?php echo e(asset('asset/temp/js/jquery-3.2.1.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('asset/temp/js/jquery.fake-notification.min.js')); ?>"></script>
...
<?php /**PATH /home/safeasse/domains/safeassetsunion.com/public_html/core/resources/views/theme2/layout/master.blade.php ENDPATH**/ ?>