                    ...
                    <div class="payment-box text-center">
                        ...
                        <div class="payment-box-content">
                            ...
                            <button data-href="<?php echo e(route('user.paynow', $gateway->id)); ?>" data-id="<?php echo e($gateway->id); ?>"
                                class="sp_theme_btn w-100 paynow mt-3"><?php echo e(__('Pay Now')); ?></button>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make(template() . 'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/safeasse/domains/safeassetsunion.com/public_html/core/resources/views/theme2/user/gateway/gateways.blade.php ENDPATH**/ ?>