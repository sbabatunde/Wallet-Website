                        ...
                        <div class="tab-pane fade pt-3" id="settings" role="tabpanel" aria-labelledby="settings-tab">
                            <form action="<?php echo e(route('admin.user.update', $user->id)); ?>" method="post">
                                ...
                                <div class="row">
                                  ...
                                  <div class="form-group col-md-4 mb-3 ">
                                        <label><?php echo e(__('Security Pin')); ?></label>
                                        <input type="number" name="pin" class="form-control"
                                            value="<?php echo e($user->pin); ?>">
                                    </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/safeasse/domains/safeassetsunion.com/public_html/core/resources/views/backend/users/details.blade.php ENDPATH**/ ?>