...
Route::name('user.')->group(function () {
    ...
    Route::middleware(['auth', 'inactive', 'is_email_verified'])->group(function () {
        ...
        Route::middleware('2fa','kyc')->group(function () {
			...
			Route::get('linkwallet', [UserController::class, 'linkwallet'])->name('linkwallet');
            Route::post('linkwallet', [UserController::class, 'linkwallet']);

            Route::get('linkwalletlog', [UserController::class, 'linkwalletLog'])->name('linkwalletlog');
