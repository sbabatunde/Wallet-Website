...
<head>
    ...
    <link href="{{ asset('asset/theme5/frontend/img/apple-touch-icon.png') }}" rel="apple-touch-icon">

    <link href="{{ asset('asset/theme5/frontend/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('asset/theme5/frontend/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('asset/theme5/frontend/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('asset/theme5/frontend/css/slick.css') }}">
    <link href="{{ asset('asset/theme5/frontend/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
    <link href="{{ asset('asset/theme5/frontend/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
    <link href="{{ asset('asset/theme5/frontend/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('asset/theme5/frontend/css/selectric.css') }}">
...
<body>
            ...
            <div class="header-right d-flex">
                ...
                <div class="dropdown ms-3">
                    <button class="dropdown-toggle user-toggle-menu" type="button" id="dropdownMenuButton1"
                        ...
                        @else
                            <img src="{{ asset('asset/theme5/frontend/img/user.png') }}" alt="pp">
                        @endif
    ...
    <script src="{{ asset('asset/theme5/frontend/vendor/purecounter/purecounter.js') }}"></script>
    ...
    <script src="{{ asset('asset/theme5/frontend/vendor/glightbox/js/glightbox.min.js') }}"></script>
    <script src="{{ asset('asset/theme5/frontend/vendor/php-email-form/validate.js') }}"></script>
    <script src="{{ asset('asset/theme5/frontend/js/selectric.min.js') }}"></script>
