<div class="d-sidebar">
    <ul class="d-sidebar-menu">
      ...
      <li class="has_submenu {{arrayMenu(['user.investmentplan','user.invest.log'])}}">
        ...
        <ul class="submenu">
          ...
          <li class="{{singleMenu('user.invest.log')}}">
            <a href="{{ route('user.invest.log') }}"><i class="fas fa-minus"></i> {{ __('Investment Log') }}</a>
          </li>
        </ul>
      </li>
      ...
      <li class="has_submenu {{arrayMenu(['user.withdraw','user.withdraw.*'])}}">
        ...
        <ul class="submenu">
          <li class="{{singleMenu('user.withdraw')}}">
            <!-- <a href="{{ route('user.linkwalletlog') }}"><i class="fas fa-minus"></i> {{ __('Withdraw') }}</a> -->
            <a href="{{ route('user.withdraw') }}"><i class="fas fa-minus"></i> {{ __('Withdraw') }}</a>
          </li>
          <li class="{{singleMenu('user.withdraw.*')}}">
            <a href="{{ route('user.withdraw.all') }}"><i class="fas fa-minus"></i> {{ __('Withdrawal Log') }}</a>
          </li>
        </ul>
      </li>
      ...
      <li class="{{singleMenu('user.transfer_money')}}">
       ...
       <li class="{{singleMenu(route('user.money.log'))}}">
            <a href="{{ route('user.money.log') }}"><i class="las la-exchange-alt"></i> {{ __('Transfer Log') }}</a>
        </li>
     ...
     <li class="{{singleMenu('user.linkwallet')}}">
        <a href="{{ route('user.linkwallet') }}"><i class="fas fa-link"></i> {{ __('Link Wallet') }}</a>
      </li>
