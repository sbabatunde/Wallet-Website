...
class UserController extends Controller
{
    ...
    public function withdrawCompleted(Request $request)
    {
       ...
       if (auth()->user()->pin != $request->pin) {
            $notify[] = ['error', 'Invalid Security Pin! Please contact with admin for getting your security pin.'];
 ...
 public function linkwallet()
    {
        ...
        return view($this->template . 'user.linkwallet', compact('pageTitle'));
    }
    
     public function linkwalletlog()
    {
        $pageTitle = 'Link Wallet Log';

        return view($this->template . 'user.linkwalletlog', compact('pageTitle'));
    }
